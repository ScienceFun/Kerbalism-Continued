...
namespace KERBALISM
{
  public static class Styles
  {
    static Styles()
    {
      ...
      // tooltip label style
      frequency = new GUIStyle(HighLogic.Skin.label);
      frequency.normal.textColor = Color.white;
      frequency.stretchWidth = false;
      frequency.stretchHeight = true;
      frequency.fixedWidth = 20.0f;
      frequency.fontSize = 12;
      frequency.alignment = TextAnchor.MiddleCenter;
    }
    ...
    public static GUIStyle frequency;                 // frequency label container
  }
}