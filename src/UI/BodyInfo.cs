  ...
  public static class BodyInfo
  {
    public static void Body_Info(this Panel p)
    {
      ...
      if (body != sun)
      {
        ...
        if (Features.Radiation) p.SetContent("radiation", Lib.HumanReadableRadiation(radiation));
        ...
        if (body.atmosphere)
        {
          ...
          if (Features.Radiation) p.SetContent("gamma absorption", Lib.HumanReadablePerc(1.0 - Sim.GammaTransparency(body, 0.0)));
        }
      }
